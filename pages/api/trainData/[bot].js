    ...
    if (session) {
        ...
        switch (req.method) {
            ...
            case "DELETE":
                ...
                connection.query("DELETE FROM taskStocks WHERE (ticker=? and name=?) and (start=? and end=?)", [req.body.ticker, bot, req.body.start, req.body.end], function(error, results, fields) {
